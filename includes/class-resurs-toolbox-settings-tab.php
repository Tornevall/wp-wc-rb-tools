...
class Tornevall_Resurs_Toolbox_Settings_Tab {
    public const TAB_KEY = 'tornevall_resurs_toolbox';
    public const RESURS_PLUGIN_FILES = [
    ...
    public static function register(): void {
        ...
        add_action('woocommerce_update_options_' . self::TAB_KEY, [Tornevall_Resurs_Toolbox_Settings::class, 'save_from_woocommerce']);
    }
    ...
    public static function add_tab(array $tabs): array {
        ...
        foreach (self::RESURS_PLUGIN_FILES as $pluginFile) {
            if (is_plugin_active($pluginFile)) {
                $resursPluginIsActive = true;
                break;
            }
        }

        if ($resursPluginIsActive && array_key_exists('resursbank', $tabs)) {
    ...
    public static function render(): void {
        Tornevall_Resurs_Toolbox_Admin_Page::render();
    }
}
